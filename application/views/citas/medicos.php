						<div class="col-12 card px-0 my-3">
							<div class="card-body">
								<h4 class="">M&eacute;dicos</h4>
								<hr>
								<div class="float-right"><a href="<?=base_url()?>citas/medicos/nuevo" class="btn btn-sabogal">Nuevo M&eacute;dico</a></div>
							</div>
