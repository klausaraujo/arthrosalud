					<div class="col-12 iq-card my-3">
						<div class="iq-card-header d-flex justify-content-between">
							<div class="iq-header-title"><h4>Edici&oacute;n de Procedimientos</h4></div>
						</div>
						<div class="iq-card-body">
								<form method="post" id="form_procedimiento" action="<?=base_url()?>citas/procedimientos/regprocedimiento"
									...
									<input type="hidden" name="idprocedimiento" value="<?=$this->input->get('id')?>" />
									<div class="container-fluid">
											<div class="row">
												...
												<div class="col-md-6 col-lg-3">
													...
													<?
														foreach($tipo as $row):	?>
															<option value="<?=$row->idtipoprocedimiento;?>" <?=$proced->idtipoprocedimiento === $row->idtipoprocedimiento?
																'selected' : ''?>><?=$row->tipo_procedimiento;?></option>
													<?	endforeach;	?>
														</select>
													</div>
												</div>
												...
												<div class="col-md-6 col-lg-4">
													<div class="row">
														<input type="text" class="form-control form-control-sm mayusc" name="procedimiento" id="procedimiento" 	
															placeholder="Procedimiento" value="<?=$proced->procedimiento?>" required="" />
											...
											<div class="row mt-3">
												...
												<div class="col-md-6 col-lg-2">
													<div class="row">
														<input type="text" class="form-control form-control-sm moneda" id="tarifa" name="tarifa" 
															placeholder="Tarifa Base" value="<?=$proced->tarifa_base?>" />
													</div>
												</div>
											</div>
									</div>
									...
									<div class="col-12 mx-auto pb-2">
										<button type="submit" class="btn btn-sabogal ml-1 mr-4" id="btnEnviar">Editar Procedimiento</button>
