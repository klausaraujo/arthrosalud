...
<body>
	...
	?>
		<header class="header<?=$i?>">
			...
			<div style="text-align:center">ORDEN DE EX&Aacute;MENES AUXILIARES NRO. <?=sprintf("%'07s",$orden->numero);?></div>
	...
	?>
		<main id="content<?=$i?>">
			<div style="margin-top:0.2cm; margin-left:0.6cm">2. DETALLE DE LA ORDEN</div>
			<table align="center" class="atenciones" cellspacing="0">
				<tbody>
					<tr><th style="width:1cm;text-align:center">C&Oacute;DIGO</th><th style="width:6cm;text-align:center">DESCRIPCI&Oacute;N</th>
						<th style="width:2cm;text-align:center">INDICACIONES</th></tr>
				<?
					foreach($detalle as $row):
				?>
					<tr class="odd_row"><td><?=$row->correlativo?></td><td style="width:3cm"><?=$row->examen_auxiliar?></td>
						<td style="width:5cm"><?=$row->indicaciones?></td></tr>
				<?
					endforeach;
				?>
				</tbody>
