						<div class="col-12 card px-0 my-3">
							<div class="card-body">
								<h4 class="">Procedimientos</h4>
								<hr>
								<div class="float-right"><a href="<?=base_url()?>citas/procedimientos/nuevo" class="btn btn-sabogal">Nuevo Procedimiento</a></div>
							</div>
