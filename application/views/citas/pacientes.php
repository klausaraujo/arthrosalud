						<div class="col-12 card px-0 my-3">
							<div class="card-body">
								...
								<hr>
								<div class="float-right"><a href="<?=base_url()?>citas/pacientes/nuevo" class="btn btn-sabogal">Nuevo Paciente</a></div>
							</div>
