					<div class="col-12 iq-card my-3">
						<div class="iq-card-header d-flex justify-content-between">
							<div class="iq-header-title"><h4>Editar Empresa</h4></div>
						</div>
						...
						<form method="post" id="form_empresa" action="<?=base_url()?>parametros/regempresa" enctype="multipart/form-data"
							...
							<input type="hidden" name="foto" value="<?=$empresa->logotipo?>" />
							<div class="form-row">
										...
										<div class="col-md-4 col-lg-2">
											<div class="row">
												<input type="text" class="form-control form-control-sm ruc borra num" name="ruc" id="ruc" placeholder="RUC" 
													value="<?=$empresa->ruc?>" minlength="11" maxlength="11" required="" />
										...
										<div class="col-md-6 col-lg-4">
											<div class="row">
												<input type="text" class="form-control form-control-sm borra nombres mayusc" name="nombres" id="nombres" 
													placeholder="Raz&oacute;n Social / Nombre Completo" value="<?=$empresa->razon_social?>" required="" />
										...
										<div class="col-md-6 col-lg-4">
											<div class="row">
												<input type="text" class="form-control form-control-sm borra direccion mayusc" name="direccion" id="direccion" 	
													placeholder="Domicilio" value="<?=$empresa->domicilio?>" required="" />
									...
									<div class="row mt-3">
										...
										<div class="col-md-6 col-lg-3">
											<div class="row">
												...
												<?
														foreach($dep as $row):	?>
															<option value="<?=$row->cod_dep;?>" <?=$row->cod_dep === substr($empresa->ubigeo,0,2)? 'selected':'';?>>
									...
									<div class="row mt-3">
										...
										<div class="col-md-6 col-lg-3">
											<div class="row">
												...
												<?
														foreach($pro as $row):	?>
															<option value="<?=$row->cod_pro;?>" <?=$row->cod_pro === substr($empresa->ubigeo,2,2)? 'selected':'';?>>
									...
									<div class="row mt-3">
										...
										<div class="col-md-6 col-lg-3">
											<div class="row">
												...
												<?
														foreach($dis as $row):	?>
															<option value="<?=$row->cod_dis;?>" <?=$row->cod_dis === substr($empresa->ubigeo,4,2)? 'selected':'';?>>
																<?=$row->distrito;?></option>
												<?		endforeach;	?>
												</select>
										...
										<div class="col-md-6 col-lg-4">
											<div class="row">
												<input type="text" class="form-control form-control-sm borra renipress mayusc" name="renipress"
													placeholder="Renipress" value="<?=$empresa->renipress?>" required="" />
