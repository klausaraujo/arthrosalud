						<div class="col-12 card px-0 my-3">
							<div class="card-body">
								<h4 class="">Lista de Servicios</h4>
								<hr>
								<div class="float-right"><a href="<?=base_url()?>logistica/servicios/nuevo" class="btn btn-sabogal">Nuevo Servicio</a></div>
							</div>
