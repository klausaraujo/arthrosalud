						<div class="col-12 card px-0 my-3">
							<div class="card-body">
								...
								<hr>
								<div class="float-right"><a href="<?=base_url()?>logistica/oc/nuevo" class="btn btn-sabogal">Nueva Orden de Compra</a></div>
							</div>
