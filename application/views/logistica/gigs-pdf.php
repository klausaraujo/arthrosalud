...
<body>
	...
	<main>
		...
		<table class="atenciones" width="100%" style="margin-top:1.5em">
			<tr><th>DESCRIPCIÓN DEL SERVICIO</th><th>CANT.</th><th>U.M</th><th>NRO. LOTE</th><th>FECHA VENC.</th><th>P.U</th><th>P.T</th></tr>
		<?
			$sumacosto = 0; $total = 0;
		...
		?>
			<tr>
				<td>&nbsp;</td><td style="text-align:center">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>
