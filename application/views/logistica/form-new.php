					<div class="col-12 iq-card my-3">
						<div class="iq-card-header d-flex justify-content-between">
							<div class="iq-header-title"><h4>Registro de Proveedores</h4></div>
						</div>
									...
									<div class="row mt-3">
										...
										<div class="col-md-6 col-lg-3">
											<div class="row">
												...
												<?
														foreach($cta as $row):	?>
															<option value="<?=$row->idtipocuenta;?>"><?=$row->tipo_cuenta;?></option>
												<?		endforeach;	?>
												</select>
											</div>
										</div>
									...
									<div class="row mt-3">
										...
										<div class="col-md-6 col-lg-3">
											<div class="row">
												...
												<?
														foreach($bco as $row):	?>
															<option value="<?=$row->idbanco;?>"><?=$row->banco;?></option>
												<?		endforeach;	?>
												</select>
											</div>
										</div>
