						<div class="col-12 card px-0 my-3">
							<div class="card-body">
								<h4 class="">Lista de Bienes</h4>
								<hr>
								<div class="float-right"><a href="<?=base_url()?>logistica/bienes/nuevo" class="btn btn-sabogal">Nuevo Art&iacute;culo</a></div>
							</div>
