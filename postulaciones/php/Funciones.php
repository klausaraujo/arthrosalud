...
if(intval(phpversion()) < 7)
	require_once($_SERVER['DOCUMENT_ROOT'].'/arthrosalud/application/libraries/Dom.php');
else
	require_once($_SERVER['DOCUMENT_ROOT'].'/arthrosalud/application/libraries/Dom1.php');
...
function descargar()
{
	$path =  $_SERVER['DOCUMENT_ROOT'].'/arthrosalud/public/adjuntos/anexos_locadores/';
...
if($_POST['data'] === 'listar'){
	...
	$path = $_SERVER['DOCUMENT_ROOT'].'/arthrosalud/public/adjuntos/anexos_postulantes/'; $i = 0;
	$a1='';$a2='';$a3='';$a4='';$a5='';$a6='';
