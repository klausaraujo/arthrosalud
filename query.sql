...
CREATE TABLE anio  (
	...
	INSERT INTO anio (anio) VALUES(2024);
...
CREATE TABLE permisos_botones  (
	...
	idusuario smallint(4) NOT NULL,
	activo char(1) DEFAULT '1',
	PRIMARY KEY (idpermisosbotones),
	FOREIGN KEY (idboton) REFERENCES botones (idboton) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY (idusuario) REFERENCES usuarios (idusuario) ON DELETE CASCADE ON UPDATE CASCADE)ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
	
	INSERT INTO permisos_botones(idpermisosbotones,idboton,idusuario) VALUES(1,1,1);
...
CREATE TABLE unidad_medida (
	idunidadmedida smallint(4) NOT NULL AUTO_INCREMENT,
	unidad_medida varchar(100) NOT NULL,
	abreviatura varchar(10),
	uso_bienes char(1) DEFAULT '0',
	uso_servicios char(1) DEFAULT '0',
	activo char(1) DEFAULT '1',
	PRIMARY KEY (idunidadmedida))ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
	
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(1,'SERVICIO','Serv','0','1');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(2,'UNIDAD','Und','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(3,'KILOGRAMO','kg','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(4,'GRAMO','g','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(5,'LITRO','L','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(6,'METRO','m','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(7,'CENTÍMETRO','cm','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(8,'MILÍMETRO','mm','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(9,'METRO CUADRADO','m²','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(10,'METRO CÚBICO','m³','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(11,'KILÓMETRO','km','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(12,'TONELADA','t','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(13,'LIBRA','lb','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(14,'ONZA','oz','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(15,'GALÓN','gal','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(16,'BARRIL','bbl','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(17,'DOCENA','doz','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(18,'CAJA','caja','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(19,'BOLSA','bolsa','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(20,'PAQUETE','paq','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(21,'BOTELLA','bot','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(22,'LATA','lata','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(23,'PIEZA','pz','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(24,'PAR','par','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(25,'ROLLO','rollo','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(26,'PALLET','pallet','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(27,'BOLSA DE KILOGRAMOS','kg','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(28,'BOLSA DE LIBRAS','lb','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(29,'JUEGO','juego','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(30,'LITRO POR MINUTO','L/min','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(31,'METRO POR SEGUNDO','m/s','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(32,'PORCENTAJE','%','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(33,'GALÓN ESTADOUNIDENSE','gal (US)','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(34,'BARRIL ESTADOUNIDENSE','bbl (US)','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(35,'CIENTO','cto','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(36,'METRO LINEAL','ml','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(37,'METRO CUADRADO POR LITRO','m²/L','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(38,'METRO CÚBICO POR HORA','m³/h','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(39,'KILÓMETRO POR HORA','km/h','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(40,'TONELADA MÉTRICA CORTA','t (corta)','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(41,'TONELADA MÉTRICA LARGA','t (larga)','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(42,'UNIDAD INTERNACIONAL','UI','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(43,'PIE CUADRADO','ft²','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(44,'PULGADA','in','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(45,'YARDA','yd','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(46,'PIE','ft','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(47,'HECTÁREA','ha','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(48,'ACRE','acre','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(49,'LIBRA POR PIE CUADRADO','lb/ft²','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(50,'ONZA POR GALÓN','oz/gal','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(51,'PIE CÚBICO POR MINUTO','ft³/min','1','0');
	INSERT INTO unidad_medida(idunidadmedida,unidad_medida,abreviatura,uso_bienes,uso_servicios) values(52,'KILOWATT HORA','kWh','1','0');

CREATE TABLE tipo_orden (
	idtipoorden smallint(4) NOT NULL AUTO_INCREMENT,
	tipo_orden varchar(20) NOT NULL,
	activo char(1) DEFAULT '1',
	PRIMARY KEY (idtipoorden))ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;
	
	INSERT INTO tipo_orden (idtipoorden,tipo_orden) VALUES (1,'ORDEN DE COMPRA');
	INSERT INTO tipo_orden (idtipoorden,tipo_orden) VALUES (2,'ORDEN DE SERVICIO');

CREATE TABLE laboratorio (
	idlaboratorio smallint(4) NOT NULL AUTO_INCREMENT,
	laboratorio varchar(100) NOT NULL,
	activo char(1) DEFAULT '1',
	PRIMARY KEY (idlaboratorio))ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;

	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(1,'NO APLICA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(2,'3M');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(3,'ABBOTT LABORATORIOS S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(4,'ABEEFE S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(5,'ABL PHARMA INTERNATIONAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(6,'AC FARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(7,'ADROFA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(8,'AKORN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(9,'ALCON PHARMACEUTICAL DEL PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(10,'ALESSI');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(11,'ALFA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(12,'ALFYMEDIX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(13,'ALKHOFAR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(14,'ALKOFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(15,'ALLERGAN INTERNACIONAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(16,'ALMEDP');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(17,'ALTECH');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(18,'AMBER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(19,'AMBU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(20,'AMERICA S.R.L');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(21,'AMERICAN FARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(22,'ANA FRANCIA  LABORATORIO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(23,'ANJACK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(24,'APOTEX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(25,'AREQUIPA SAC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(26,'ARMOUR FARMACEUTICA DEL PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(27,'ARTICULOS DE OFICINA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(28,'ASPEN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(29,'ASTELLAS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(30,'ASTRA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(31,'ATRAL DEL PERU (DIST PHARBAL)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(32,'AXION S.A.[LABORAT. CHILE ]');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(33,'AXON PHARAMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(34,'BAGO DEL PERU S.A LABORATORIOS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(35,'BARRENNE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(36,'BAUSH & LOMB');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(37,'BAXTER DEL PERU S.A   LABOR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(38,'BAYER PERU S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(39,'BENDI-C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(40,'BENMEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(41,'BERNA INSTITUTO SUEROTERAPIA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(42,'BIABIC E.I.R.L.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(43,'BIOBASAL S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(44,'BIODESCARTEX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(45,'BIOLIFE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(46,'BIO-MEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(47,'BIOPLIX BIOQUIMICA APLICADA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(48,'BIOSANO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(49,'BLESS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(50,'BLUNDING');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(51,'BOEHRINGER INGELHEIM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(52,'BOLIVAR FARMA S.R. LTDA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(53,'BONAPHARM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(54,'BRAUN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(55,'BRISTOL MYERS (MAQUIFASA)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(56,'BYK GULDEN PHARMAZEUTIKA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(57,'C&D');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(58,'CAFERMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(59,'CAPLIN POINT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(60,'CARDIOV & ENDOCR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(61,'CARESTREAM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(62,'CARRION S.A.(REFASA)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(63,'CD VENTAS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(64,'CECI FARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(65,'CENTROLAB');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(66,'CHATTEM INC.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(67,'CIBA VISION OPHTHALM DISPERSA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(68,'CIPA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(69,'CIRON DROUG');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(70,'CIRUGIA PERUANA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(71,'CKF');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(72,'CODIEX-ORTHO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(73,'COFANA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(74,'COLGATE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(75,'COLICHON S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(76,'COLLIERE S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(77,'CONOD');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(78,'CONTINENTAL OPTICAL S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(79,'CONTINENTAL S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(80,'CONVATEC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(81,'COPPON');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(82,'COQUITO-INSTITUTO REMY');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(83,'CORVAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(84,'COSUM.HEALTH C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(85,'CRESPAL S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(86,'CRIOFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(87,'CSPC ZHONGNUO PHARMACEUTICAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(88,'CUREBAND');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(89,'CUTENOX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(90,'D&M PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(91,'DANPAR SALUD');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(92,'DANY');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(93,'DELFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(94,'DELFIN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(95,'DERMATOLOGY');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(96,'DEUTSCHE PHARMA S.A.C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(97,'DIPHASAC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(98,'DISNEY');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(99,'DISPOWAY');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(100,'DOCTOR ANDREU Q.F. S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(101,'DR. ZAIDMAN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(102,'DRAGER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(103,'DROKASA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(104,'DROPESAC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(105,'E&C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(106,'ECOFLAC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(107,'EDGEWELL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(108,'ELIFARMA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(109,'EMCURE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(110,'ERZA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(111,'ESKE CORPORATION S.A.C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(112,'ESLIMEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(113,'ESTERIJECT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(114,'ETANFOR S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(115,'EUROFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(116,'FAMILY DOCTOR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(117,'FARBIOQUIMSA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(118,'FARMAGROUP S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(119,'FARMAKONSUMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(120,'FARMASUR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(121,'FARMINDUSTRIA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(122,'FARMO-ANDINA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(123,'FARMUR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(124,'FARPASA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(125,'FARVET');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(126,'FERRER INTERNACIONAL S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(127,'FITOMEDIS S.R.L');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(128,'FLEET CO. INC. LABORATORIO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(129,'FLEXICARE MEDICAL LTD.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(130,'FRESENIUS KABI PERU S.A.C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(131,'FRESOFOL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(132,'GALAXO SMITHKLINE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(133,'GALDERMAN PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(134,'GALENO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(135,'GALENTIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(136,'GAMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(137,'GARDEN HOUSE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(138,'GEMEFAR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(139,'GENCOPHARMACEUTICAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(140,'GEN-FAR PERU S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(141,'GENOMMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(142,'GENTS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(143,'GEPHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(144,'GIANFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(145,'GLAXO WELLCOME S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(146,'GLENMARK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(147,'GOLDLINE LABORATORIES');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(148,'GRANVILL PHARMACEUTICAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(149,'GRUNENTHAL PERUANA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(150,'GSK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(151,'GYPSONA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(152,'HAARLEM/UNIPHARM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(153,'HEALTH C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(154,'HEALTIUM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(155,'HERSIL S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(156,'HI-MED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(157,'HK PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(158,'HOECHST MARION ROUSSEL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(159,'HOFARM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(160,'HP');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(161,'HSINER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(162,'IBESA S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(163,'ICI PERU S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(164,'INDUFAR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(165,'INDUQUIMICA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(166,'INFARMASA S.A.(MAGMA-SANITAS)G');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(167,'INOVAMEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(168,'INPHARZAN S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(169,'INSTANT PROFESIONAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(170,'INSTITUTO QUIMIOTERAPICO S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(171,'INSTITUTO SANITAS S.P.S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(172,'INTRADEVCO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(173,'INTRAVEN S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(174,'IQ FARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(175,'IQ MEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(176,'ITF');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(177,'JANSSEN FARMACEUTICA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(178,'JENFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(179,'JIANGSU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(180,'JOHNSON & JOHNSON DEL PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(181,'JPS DISTRIBUCIONES');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(182,'JULPHARMA DEL PERU S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(183,'JYG DIAMEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(184,'JZIKI');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(185,'KDL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(186,'KIMBERLY-CLARK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(187,'KIP');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(188,'KL&M');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(189,'KNOLL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(190,'KOPRAN (OSN-ES LA DISTRI)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(191,'KOR-PERU S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(192,'LA SANTE LABORATORIOS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(193,'LABOFAR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(194,'LABOGEN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(195,'LABORATORIA PISA S.A (PROHOSA)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(196,'LABORATORIO GP');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(197,'LABORATORIO MAZALI');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(198,'LABORATORIO ROBBINS S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(199,'LABORATORIOS AMERICANOS LABOT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(200,'LABORATORIOS UNIDOS S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(201,'LABOTT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(202,'LAFAR PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(203,'LAFARMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(204,'LANSIER LABORATORIO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(205,'LAQUIFASA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(206,'LARPE S.A.- ROUSSEL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(207,'LASER FARMACEUTICA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(208,'LEDERLE (LAB WYETH S.A)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(209,'LEMERY (DISTRIB OSN P/EL PERU)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(210,'LILLY INTERAMERICANA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(211,'LINEA GUIBRA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(212,'LIPHA SANTE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(213,'LUKOLL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(214,'LUSA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(215,'MAGMA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(216,'MALDONADO S.A.LABORAT.FARMACEU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(217,'MANAX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(218,'MARFAN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(219,'MARKOS S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(220,'MASON');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(221,'MATERIALES,INSUMOS MEDICOS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(222,'MAVER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(223,'MCKESSON CO.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(224,'MEDEX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(225,'MEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(226,'MEDICAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(227,'MEDICAL B&T');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(228,'MEDICAL SOLUTIONS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(229,'MEDICALS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(230,'MEDICUBA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(231,'MEDIFARMA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(232,'MEDIX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(233,'MEDROCK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(234,'MEGA WE CARE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(235,'MEGALABS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(236,'MEGALABS ROEMMERS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(237,'MENARINI');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(238,'MEPHA  (ALBIS ES LA DISTRI)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(239,'MERCK PERUANA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(240,'MERCK SHARP & DOHME');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(241,'MERREL LEPETIT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(242,'MKT PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(243,'MONT GROUP');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(244,'MYM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(245,'NATUMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(246,'NATURALFA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(247,'NATURAMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(248,'NEOPAN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(249,'NEUMOBIOTICS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(250,'NEUTROGENA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(251,'NEWPORT PHARMACEUTICALS INT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(252,'NICOLICH');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(253,'NIPRO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(254,'NORDIC PHARMACEUTICAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(255,'NORMON');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(256,'NOVARTIS BIOSCIENCES PERU S.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(257,'NOVO NORDISK (DINAMAR)(PROHOSA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(258,'NUTRACEUTICAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(259,'OCULUS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(260,'OM PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(261,'OMNIA PHARMA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(262,'ONEJECT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(263,'ONEPLUS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(264,'OQ PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(265,'ORGANON INTERNACIONAL BV');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(266,'OTAVASQ');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(267,'PAINT & GASTROEN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(268,'PAJUNK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(269,'PAKFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(270,'PAKISTAN INDUSTRIALES');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(271,'PANALAB');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(272,'PARKE DAVIS WARNER LAMBER PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(273,'PASCOE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(274,'PASTEUR MERIEUX CONNAUGHT');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(275,'PAVIL-PHARVET');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(276,'PENTACOOP');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(277,'PERUANO GERMANO S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(278,'PERUGEN (PERUANA DE GENERICOS)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(279,'PERULAC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(280,'PFIZER CORPORATION');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(281,'PHARMA CHECK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(282,'PHARMA GENERICOS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(283,'PHARMA INVESTI PERU S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(284,'PHARMACIA & UPJOHN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(285,'PHARMADA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(286,'PHARMAGEN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(287,'PHARMALAB S.A LABORATORIO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(288,'PHARMED CORPORATION S.A.C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(289,'PLENITUD');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(290,'POEN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(291,'POLY-GEN (ES UNA DIVI DE TRIFA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(292,'POLYMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(293,'PORTUGAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(294,'PROBIOL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(295,'PROCTER & GAMBLE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(296,'PROFARMA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(297,'PRUEBA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(298,'PRUEBA LABORATORIO-A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(299,'Q MEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(300,'QM PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(301,'QUALIMAX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(302,'QUALIPHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(303,'QUEMEDIC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(304,'QUILAB FARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(305,'QUIMEDIC PLUS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(306,'QUIMICA ARISTON PERU S.R.LTDA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(307,'QUIROFANO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(308,'RESPIRATOR CARE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(309,'REUTER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(310,'REYES S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(311,'RHONE POULENC RORER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(312,'RICHARDSON VICK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(313,'ROCHE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(314,'ROEMMERS S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(315,'ROHA-PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(316,'ROKER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(317,'ROMSONS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(318,'ROPSOHN THERAPEUTICS LTDA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(319,'ROSTER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(320,'ROVIAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(321,'ROWA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(322,'ROWEFEM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(323,'ROXFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(324,'RUSCH');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(325,'SABZ');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(326,'SAFELET');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(327,'SAGALL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(328,'SAKAR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(329,'SANCELA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(330,'SANCELA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(331,'SANDERSON S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(332,'SANOFI AVENTIS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(333,'SANOFI WINTHROP');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(334,'SANTOLEE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(335,'SAVAL S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(336,'SCHEIN FARMACEUTICA DEL PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(337,'SCHERING FARMACEUTICA PERUANA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(338,'SCHERING PLOUGH INTERNACIONAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(339,'SEARLE INTERAMERICANA CO.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(340,'SECOS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(341,'SEGURIMAX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(342,'SERVIPHARM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(343,'SHANDONG SHENGLU PHARMACEUTICAL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(344,'SHERFARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(345,'SHERFARMA LAB. (DIST/DECO)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(346,'SHICK');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(347,'SHINMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(348,'SIEGFRIED S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(349,'SIFI');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(350,'SIGMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(351,'SILESIA PERU S.A. LABORATORIO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(352,'SIN FABRICANTE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(353,'SMART PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(354,'SMITH');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(355,'SOLCO BASILEA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(356,'SOLIFARM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(357,'SOLOPAK UNIPHARM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(358,'SONY');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(359,'SOPHIA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(360,'SOUTHERN PHARMACUTICALS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(361,'SQUIBB BRISTOL-MYERS MAQUIFASA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(362,'SRL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(363,'STERILAB');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(364,'STERIMAXX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(365,'STIEFEL DEL PERU LABOR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(366,'SUIPHAR DEL PERU S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(367,'SULCAGEL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(368,'SUN PHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(369,'SUNDOWN (VITAMINA)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(370,'SUNMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(371,'SURU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(372,'SUTUMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(373,'SWISS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(374,'SYNTHELABO-DELAGRANGE DEL PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(375,'SZAB');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(376,'TAGUM');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(377,'TECHSPHERE');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(378,'TECNOFARMA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(379,'TEKEDA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(380,'TELEFLEX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(381,'TERBONOVA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(382,'TEVA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(383,'TEVA COFANA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(384,'TEVA MAGNA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(385,'TEVA SANITAS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(386,'TEVA THERAMEX');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(387,'THEFAR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(388,'THERAMEX (DIST PROFARMA)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(389,'TOTTUS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(390,'TRANSQUIN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(391,'TRIFARMA S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(392,'TUINIES');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(393,'UNIDOS S.AC');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(394,'UNILENE S.A.C');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(395,'UNILEVER');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(396,'UNIMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(397,'UNIMED DEL PERU S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(398,'UNION FARM. NACIONAL S.R.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(399,'UNITED PHAMACEUTICAL DEL PERU');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(400,'URITEL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(401,'USV PHARMACEUTICAL CORP.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(402,'VASOPRES');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(403,'VCIN');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(404,'VELHIANGEL');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(405,'VENOJET');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(406,'VIFOR');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(407,'VINCENT RD');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(408,'VITALIS');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(409,'VITAMINICA S.A. LABORATORIO');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(410,'VITAPHARMA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(411,'VITROMED');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(412,'WASSER CHEMICAL LTDA');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(413,'WELFARK PERU S.A.');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(414,'WHITEHALL-ROBIN (LAB WYETH S.A');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(415,'WOMEN''S HEALTH');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(416,'WYETH-AYERST (LAB WYETH S.A)');
	INSERT INTO laboratorio(idlaboratorio,laboratorio) values(417,'ZAMBON GRUOP (DIST PROFARMA)');

CREATE TABLE tipo_articulo (
	idtipoarticulo smallint(4) NOT NULL AUTO_INCREMENT,
	tipo_articulo varchar(50) NOT NULL,
	activo char(1) DEFAULT '1',
	PRIMARY KEY (idtipoarticulo))ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;

	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(1,'NO CLASIFICADOS');
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(2,'ACTIVOS FIJOS');
	...
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(19,'OTROS');
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(20,'PERFUMERIA');
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(21,'PRODUCTOS DE TOCADOR');
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(22,'PRODUCTOS LACTEOS');
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(23,'PRODUCTOS PARA BEBE');
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(24,'REACTIVOS');
	INSERT INTO tipo_articulo(idtipoarticulo,tipo_articulo) values(25,'VITAMINAS');

CREATE TABLE presentacion (
	idpresentacion smallint(4) NOT NULL AUTO_INCREMENT,
	presentacion varchar(50) NOT NULL,
	activo char(1) DEFAULT '1',
	PRIMARY KEY (idpresentacion))ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci;

	INSERT INTO presentacion(idpresentacion,presentacion) values(1,'NO ESPECIFICA');
	INSERT INTO presentacion(idpresentacion,presentacion) values(2,'AMPOLLA');
	INSERT INTO presentacion(idpresentacion,presentacion) values(3,'CAJA');
	INSERT INTO presentacion(idpresentacion,presentacion) values(4,'CAPSULA');
	INSERT INTO presentacion(idpresentacion,presentacion) values(5,'FRASCO');
	INSERT INTO presentacion(idpresentacion,presentacion) values(6,'GALON');
	INSERT INTO presentacion(idpresentacion,presentacion) values(7,'GRAMOS');
	INSERT INTO presentacion(idpresentacion,presentacion) values(8,'LITROS');
	INSERT INTO presentacion(idpresentacion,presentacion) values(9,'MILILITROS');
	INSERT INTO presentacion(idpresentacion,presentacion) values(10,'PAQUETE');
	INSERT INTO presentacion(idpresentacion,presentacion) values(11,'TABLETA');
	INSERT INTO presentacion(idpresentacion,presentacion) values(12,'TIRA');
	INSERT INTO presentacion(idpresentacion,presentacion) values(13,'UNIDAD');
